...
export default async function AboutPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const stats = [
    { value: '1,300+', labelKey: 'home.stats_emojis' as const },
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-slate-600">Unicode has defined over 3,600 emojis. EmojiDict currently covers 1,300+ of the most commonly used ones, with more being added regularly.</p>
          </div>
          <div>
